...
public class RegisterVende extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(view -> {
            ...
            if (nombre.isEmpty() || cedula.isEmpty() || celular.isEmpty() || direcccion.isEmpty() || correo.isEmpty() || contrasena.isEmpty()) {
                ...
                if (metodos.addVendedor(user)) {
                    Toast.makeText(getApplicationContext(), "Vendedor registrado exitosamente", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(RegisterVende.this, Login.class));
                    finish();
                } else {
                    Toast.makeText(getApplicationContext(), "Error al registrar vendedor, valide los campos", Toast.LENGTH_SHORT).show();
                }
            }
        });
